  ...
  return (
    <div className='FormPage'>
      ...
      <div className="MainInputs">
        <input type="text" placeholder='Ism Familya' />
        <InputMask id="phone" mask="(99) 999-99-99" placeholder="Telefon Raqamingiz"></InputMask>
        <a className="button" onClick={() => navigate('/congratulations')}>
